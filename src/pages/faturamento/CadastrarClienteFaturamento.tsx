...
export default function CadastrarClienteFaturamento() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-10">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Cadastro direto no sistema — sem aprovação</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Button type="button" variant="outline" onClick={() => navigate("/faturamento/clientes")}>
            Cancelar
          </Button>
