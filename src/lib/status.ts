export const STATUS_LABEL: Record<string, string> = {
  ...
  faturado: "Faturado",
  parcialmente_faturado: "Aguardando faturamento",
  ...
  aguardando_aprovacao_desconto: "Aguardando aprovação de desconto",
...
export const STATUS_COLOR: Record<string, string> = {
  ...
  parcialmente_faturado: "bg-blue-100 text-blue-800 border-blue-300",
  ...
  aguardando_aprovacao_desconto: "bg-purple-100 text-purple-800 border-purple-300",
